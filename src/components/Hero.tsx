...
import profilePhoto from '@/assets/atish-profile-photo.jpg';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
                ...
                <Button 
                  ...
                  onClick={() => window.open('Adh101/analytic-essence-page/public/Resume_Atish_Dhamala.pdf', '_blank')}
                >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                <div className="w-80 h-96 md:w-96 md:h-[28rem] rounded-2xl overflow-hidden border-4 border-neutral-custom-light shadow-2xl">
                  <img 
                    src={profilePhoto} 
